...
HOST FILESYSTEM: /tmp and other host paths are NOT accessible from the sandbox.
  ...
  When fs-write is enabled, large output is automatically saved to the results/
  directory (readable via execute_bash "cat results/..." or read_output).
  Use those paths instead.
